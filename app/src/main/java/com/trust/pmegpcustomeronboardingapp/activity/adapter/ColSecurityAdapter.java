...
public class ColSecurityAdapter extends RecyclerView.Adapter<ColSecurityAdapter.ClassViewHolder> {
    ...
    @NonNull
    @Override
    public ColSecurityAdapter.ClassViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.adapter_applicant_age_item, parent, false);
        return new ColSecurityAdapter.ClassViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull ColSecurityAdapter.ClassViewHolder holder, @SuppressLint("RecyclerView") int position) {
