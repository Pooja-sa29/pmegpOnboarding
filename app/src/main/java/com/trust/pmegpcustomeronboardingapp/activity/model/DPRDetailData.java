...
public class DPRDetailData {
    ...
    private Boolean isUnderValidation;
    @SerializedName("isUnderVarification")
    private Boolean isUnderVarification;
    @SerializedName("isMMDisbursementByVarification")
    private Boolean isMMDisbursementByVarification;
    @SerializedName("isReferredBackByVarification")
    private Boolean isReferredBackByVarification;
    @SerializedName("isReturnedBackByValidation")
    private Boolean isReturnedBackByValidation;
    @SerializedName("isMMApprovedByValidation")
    private Boolean isMMApprovedByValidation;
    @SerializedName("isRefferedImplementingOrBankByValidation")
    private Boolean isRefferedImplementingOrBankByValidation;
    @SerializedName("isForwardedByImplementingOrBankToVerification")
    private Boolean isForwardedByImplementingOrBankToVerification;
    ...
    private Boolean isPhyReverified;
    @SerializedName("IsApplUpdForRet")
    private Boolean IsApplUpdForRet;
    @SerializedName("TrainingMode")
    private boolean TrainingMode;
    @SerializedName("isReturnedByBankAndForwadedByVar")
    private Boolean isReturnedByBankAndForwadedByVar;
    @SerializedName("isReturnedByValAndForwadedByVar")
    private Boolean isReturnedByValAndForwadedByVar;
    ...
    public Boolean getUnderValidation() {
        return isUnderValidation;
    }

    public void setUnderValidation(Boolean underValidation) {
        isUnderValidation = underValidation;
    }

    public Boolean getUnderVarification() {
        return isUnderVarification;
    }

    public void setUnderVarification(Boolean underVarification) {
        isUnderVarification = underVarification;
    }

    public Boolean getMMDisbursementByVarification() {
        return isMMDisbursementByVarification;
    }

    public void setMMDisbursementByVarification(Boolean MMDisbursementByVarification) {
        isMMDisbursementByVarification = MMDisbursementByVarification;
    }

    public Boolean getReferredBackByVarification() {
        return isReferredBackByVarification;
    }

    public void setReferredBackByVarification(Boolean referredBackByVarification) {
        isReferredBackByVarification = referredBackByVarification;
    }

    public Boolean getReturnedBackByValidation() {
        return isReturnedBackByValidation;
    }

    public void setReturnedBackByValidation(Boolean returnedBackByValidation) {
        isReturnedBackByValidation = returnedBackByValidation;
    }

    public Boolean getMMApprovedByValidation() {
        return isMMApprovedByValidation;
    }

    public void setMMApprovedByValidation(Boolean MMApprovedByValidation) {
        isMMApprovedByValidation = MMApprovedByValidation;
    }

    public Boolean getRefferedImplementingOrBankByValidation() {
        return isRefferedImplementingOrBankByValidation;
    }

    public void setRefferedImplementingOrBankByValidation(Boolean refferedImplementingOrBankByValidation) {
        isRefferedImplementingOrBankByValidation = refferedImplementingOrBankByValidation;
    }

    public Boolean getForwardedByImplementingOrBankToVerification() {
        return isForwardedByImplementingOrBankToVerification;
    }

    public void setForwardedByImplementingOrBankToVerification(Boolean forwardedByImplementingOrBankToVerification) {
        isForwardedByImplementingOrBankToVerification = forwardedByImplementingOrBankToVerification;
    }
    ...
    public Boolean getApiHit() {
        return IsApiHit;
    }

    public void setApiHit(Boolean apiHit) {
        IsApiHit = apiHit;
    }
    ...
    public Boolean getApplClose() {
        return IsApplClose;
    }

    public void setApplClose(Boolean applClose) {
        IsApplClose = applClose;
    }
    ...
    public Boolean getPhyReverified() {
        return isPhyReverified;
    }

    public void setPhyReverified(Boolean phyReverified) {
        isPhyReverified = phyReverified;
    }

    public Boolean getApplUpdForRet() {
        return IsApplUpdForRet;
    }

    public void setApplUpdForRet(Boolean applUpdForRet) {
        IsApplUpdForRet = applUpdForRet;
    }
    ...
    public Boolean getReturnedByBankAndForwadedByVar() {
        return isReturnedByBankAndForwadedByVar;
    }

    public void setReturnedByBankAndForwadedByVar(Boolean returnedByBankAndForwadedByVar) {
        isReturnedByBankAndForwadedByVar = returnedByBankAndForwadedByVar;
    }

    public Boolean getReturnedByValAndForwadedByVar() {
        return isReturnedByValAndForwadedByVar;
    }

    public void setReturnedByValAndForwadedByVar(Boolean returnedByValAndForwadedByVar) {
        isReturnedByValAndForwadedByVar = returnedByValAndForwadedByVar;
    }
