...
public class RepaymentAdapter extends RecyclerView.Adapter<RepaymentAdapter.ClassViewHolder> {
    ...
    @NonNull
    @Override
    public RepaymentAdapter.ClassViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.adapter_applicant_age_item, parent, false);
        return new RepaymentAdapter.ClassViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull RepaymentAdapter.ClassViewHolder holder, @SuppressLint("RecyclerView") int position) {
