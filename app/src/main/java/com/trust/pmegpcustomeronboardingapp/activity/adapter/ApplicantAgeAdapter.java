...
public class ApplicantAgeAdapter extends RecyclerView.Adapter<ApplicantAgeAdapter.ClassViewHolder> {
    ...
    public ApplicantAgeAdapter(List<ScoreCard.ScoreParameter> classList, OnDocUploadClickListener listener) {
    ...
    @NonNull
    @Override
    public ApplicantAgeAdapter.ClassViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.adapter_applicant_age_item, parent, false);
        return new ApplicantAgeAdapter.ClassViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull ApplicantAgeAdapter.ClassViewHolder holder, @SuppressLint("RecyclerView") int position) {
